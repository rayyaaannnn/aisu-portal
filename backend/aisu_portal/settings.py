"""
Django settings for aisu_portal project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-%2tb5-u#llm2vbv9@h7y*b8+h-1&v^=97l=sj)*ztu^2j85^&*')
...
WSGI_APPLICATION = 'aisu_portal.wsgi.application'
